...
object Topmarks {
    ...
    val RadarReflector = Symbol().apply {
        add(Instr(Form.BBOX, Rectangle2D.Double(-50.0, -40.0, 100.0, 40.0)))
        add(Instr(Form.STRK, BasicStroke(6f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_MITER)))
        add(Instr(Form.FILL, black))
        val p = Path2D.Double()
        p.moveTo(-30.0, -3.0)
    ...
    val TopBesom = Symbol().apply {
        add(Instr(Form.BBOX, Rectangle2D.Double(-20.0, -80.0, 40.0, 80.0)))
    ...
    val TopCan = Symbol().apply {
        ...
        add(Instr(Form.STRK, BasicStroke(4f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_MITER)))
        add(Instr(Form.FILL, black))
        add(Instr(Form.LINE, Line2D.Double(0.0, 0.0, 0.0, -15.0)))
        p = Path2D.Double()
        p.moveTo(-12.0, -15.0)
        p.lineTo(-12.0, -48.0)
        p.lineTo(12.0, -48.0)
    ...
    val TopConeSphere = Symbol().apply {
        ...
        add(Instr(Form.FILL, black))
        add(Instr(Form.LINE, Line2D.Double(0.0, 0.0, 0.0, -15.0)))
        add(Instr(Form.LINE, Line2D.Double(0.0, -42.0, 0.0, -47.0)))
        p = Path2D.Double()
        p.moveTo(-15.0, -47.0)
        p.lineTo(0.0, -77.0)
        p.lineTo(15.0, -47.0)
        p.closePath()
        add(Instr(Form.ELPS, Ellipse2D.Double(-14.0, -42.0, 28.0, 28.0)))
        add(Instr(Form.PLIN, p))
    }

    val TopCross = Symbol().apply {
        add(Instr(Form.BBOX, Rectangle2D.Double(-30.0, -80.0, 60.0, 80.0)))
        val colours = Symbol()
        var p = Path2D.Double()
        p.moveTo(-5.0, -15.0)
        p.lineTo(-5.0, -32.5)
    ...
    val TopEast = Symbol().apply {
        ...
        add(Instr(Form.STRK, BasicStroke(4f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_MITER)))
        add(Instr(Form.FILL, black))
        add(Instr(Form.LINE, Line2D.Double(0.0, 0.0, 0.0, -10.0)))
        add(Instr(Form.LINE, Line2D.Double(0.0, -43.0, 0.0, -47.0)))
        add(Instr(Form.STRK, BasicStroke(2f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_MITER)))
        p = Path2D.Double()
        p.moveTo(0.0, -10.0)
        p.lineTo(-15.0, -43.0)
    ...
    val TopFlag = Symbol().apply {
        ...
        add(Instr(Form.STRK, BasicStroke(4f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_MITER)))
        add(Instr(Form.FILL, black))
        add(Instr(Form.LINE, Line2D.Double(0.0, 0.0, 0.0, -45.0)))
        add(Instr(Form.STRK, BasicStroke(2f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_MITER)))
        add(Instr(Form.RECT, Rectangle2D.Double(0.0, -40.0, 39.0, 30.0)))
    }
    ...
    val TopIsol = Symbol().apply {
        ...
        add(Instr(Form.LINE, Line2D.Double(0.0, 0.0, 0.0, -15.0)))
        add(Instr(Form.STRK, BasicStroke(2f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_MITER)))
        add(Instr(Form.ELPS, Ellipse2D.Double(-13.0, -41.0, 26.0, 26.0)))
        add(Instr(Form.ELPS, Ellipse2D.Double(-13.0, -68.0, 26.0, 26.0)))
    }
    ...
    val TopMooring = Symbol().apply {
        ...
        add(Instr(Form.FILL, black))
        add(Instr(Form.ELPS, Ellipse2D.Double(-1.5, -6.0, 3.0, 3.0)))
        add(Instr(Form.ELPS, Ellipse2D.Double(-8.5, -25.0, 17.0, 17.0)))
    }
    ...
    val TopSphereRhombus = Symbol().apply {
        add(Instr(Form.BBOX, Rectangle2D.Double(-30.0, -80.0, 60.0, 80.0)))
        add(Instr(Form.SYMB, SubSymbol(TopRhombus, 1.0, 0.0, 0.0, null, null)))
        val colours = Symbol()
        val p = Path2D.Double()
        p.moveTo(-14.0, -44.0)
        ...
        add(Instr(Form.FILL, black))
        add(Instr(Form.STRK, BasicStroke(2f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_MITER)))
        add(Instr(Form.ELPS, Ellipse2D.Double(-14.0, -58.0, 28.0, 28.0)))
    }
    ...
    val TopX = Symbol().apply {
        ...
        add(Instr(Form.STRK, BasicStroke(4f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_MITER)))
        add(Instr(Form.FILL, black))
        add(Instr(Form.LINE, Line2D.Double(0.0, 0.0, 0.0, -27.0)))
        add(Instr(Form.STRK, BasicStroke(2f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_MITER)))
        p = Path2D.Double()
        p.moveTo(0.0, -27.7)
        p.lineTo(-12.4, -15.7)
