...
object Facilities {
    ...
    val Facility = Symbol().apply {
        ...
        add(Instr(Form.FILL, Color(-0x7f000001, true)))
        val s = RoundRectangle2D.Double(-29.0, -29.0, 58.0, 58.0, 15.0, 15.0)
        add(Instr(Form.RSHP, s))
        add(Instr(Form.FILL, Color(0xa30075)))
        add(Instr(Form.RRCT, s))
    }

    val Boatlift = Symbol().apply {//was Crane
        add(Instr(Form.BBOX, Rectangle2D.Double(-30.0, -30.0, 60.0, 60.0)))
        add(Instr(Form.SYMB, SubSymbol(Facility, 1.0, 0.0, 0.0, null, null)))
        add(Instr(Form.STRK, BasicStroke(4f, BasicStroke.CAP_ROUND, BasicStroke.JOIN_ROUND)))
        add(Instr(Form.ELPS, Ellipse2D.Double(-3.7, -19.7, 12.0, 12.0)))
        add(Instr(Form.LINE, Line2D.Double(2.3, -7.7, 2.3, -2.0)))
        add(Instr(Form.EARC, Arc2D.Double(-10.0, -1.5, 20.0, 20.0, 75.0, -260.0, Arc2D.OPEN)))
    }
    ...
    val Boatyard = Symbol().apply {
        ...
        add(Instr(Form.LINE, Line2D.Double(19.0, 19.0, -8.0, -8.0)))
        val p = Path2D.Double()
        p.moveTo(-11.3, -11.3)
        p.lineTo(-10.5, -17.5)
        p.lineTo(-14.8, -21.9)
    ...
    val Chandler = Symbol().apply {
        ...
        add(Instr(Form.ELPS, Ellipse2D.Double(14.0, 7.0, 10.0, 10.0)))
        add(Instr(Form.LINE, Line2D.Double(-23.0, 12.0, 14.0, 12.0)))
        add(Instr(Form.LINE, Line2D.Double(8.0, 21.0, 8.0, -8.6)))
        add(Instr(Form.LINE, Line2D.Double(-16.0, 21.0, -16.0, -8.6)))
        add(Instr(Form.EARC, Arc2D.Double(-16.0, -20.5, 24.0, 24.0, 0.0, 180.0, Arc2D.OPEN)))
    }
    ...
    val Laundrette = Symbol().apply {
        add(Instr(Form.BBOX, Rectangle2D.Double(-30.0, -30.0, 60.0, 60.0)))
        add(Instr(Form.SYMB, SubSymbol(Facility, 1.0, 0.0, 0.0, null, null)))
        add(Instr(Form.STRK, BasicStroke(1.5f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND)))
        add(Instr(Form.FILL, Color(0xa30075)))
        add(Instr(Form.RECT, Rectangle2D.Double(-15.0, -15.0, 30.0, 30.0)))
    ...
    val PumpOut = Symbol().apply {
        add(Instr(Form.BBOX, Rectangle2D.Double(-30.0, -30.0, 60.0, 60.0)))
        add(Instr(Form.SYMB, SubSymbol(Facility, 1.0, 0.0, 0.0, null, null)))
        add(Instr(Form.STRK, BasicStroke(2.5f, BasicStroke.CAP_ROUND, BasicStroke.JOIN_MITER)))
        add(Instr(Form.FILL, Color(0xa30075)))
        var p = Path2D.Double()
        p.moveTo(3.9, -3.7)
        p.lineTo(-7.4, -3.7)
        ...
        p.lineTo(13.5, 3.1)
        add(Instr(Form.PLIN, p))
        add(Instr(Form.STRK, BasicStroke(3.5f, BasicStroke.CAP_ROUND, BasicStroke.JOIN_ROUND)))
        p = Path2D.Double()
        p.moveTo(-2.5, 3.0)
        p.lineTo(-2.5, -13.8)
        p.lineTo(6.9, -13.8)
    ...
    val SailingClub = Symbol().apply {
        ...
        add(Instr(Form.FILL, Color(0xa30075)))
        add(Instr(Form.LINE, Line2D.Double(-5.0, 20.0, -5.0, -20.0)))
        val p = Path2D.Double()
        p.moveTo(-5.0, 0.0)
        p.lineTo(20.0, -10.0)
        p.lineTo(-5.0, -20.0)
    ...
    val Shower = Symbol().apply {
        ...
        add(Instr(Form.FILL, Color(0xa30075)))
        add(Instr(Form.LINE, Line2D.Double(-4.8, -24.5, 6.2, -13.5)))
        add(Instr(Form.STRK, BasicStroke(2f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND)))
        add(Instr(Form.LINE, Line2D.Double(-18.1, -17.9, -6.1, -21.3)))
        add(Instr(Form.LINE, Line2D.Double(-13.9, -10.2, -3.9, -17.7)))
        add(Instr(Form.LINE, Line2D.Double(-7.8, -4.4, -0.5, -14.3)))
        add(Instr(Form.LINE, Line2D.Double(-0.2, -0.2, 3.1, -12.1)))
        val p = Path2D.Double()
        p.moveTo(11.1, 24.6)
        p.lineTo(11.1, -16.0)
    ...
    val Slipway = Symbol().apply {
        ...
        p.closePath()
        add(Instr(Form.PGON, p))
        add(Instr(Form.ELPS, Ellipse2D.Double(-1.65, -1.9, 8.0, 8.0)))
        add(Instr(Form.STRK, BasicStroke(2f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND)))
        add(Instr(Form.LINE, Line2D.Double(-24.5, -8.3, -3.1, -2.4)))
        add(Instr(Form.LINE, Line2D.Double(9.3, 1.1, 22.2, 4.6)))
        p = Path2D.Double()
        p.moveTo(22.9, 0.6)
        p.lineTo(25.0, -7.4)
        p.lineTo(-5.1, -15.8)
    ...
    val Toilet = Symbol().apply {
        ...
        add(Instr(Form.RSHP, Ellipse2D.Double(-18.5, -22.5, 7.4, 7.4)))
        add(Instr(Form.RSHP, Ellipse2D.Double(11.0, -22.5, 7.4, 7.4)))
        var p = Path2D.Double()
        p.moveTo(-9.8, -12.2)
        p.lineTo(-4.8, 2.7)
        p.lineTo(-7.3, 3.9)
    ...
    val VisitorBerth = Symbol().apply {
        add(Instr(Form.BBOX, Rectangle2D.Double(-30.0, -30.0, 60.0, 60.0)))
        add(Instr(Form.FILL, Color(0xa30075)))
        add(Instr(Form.RSHP, Ellipse2D.Double(-25.0, -25.0, 50.0, 50.0)))
    ...
    val VisitorMooring = Symbol().apply {
        ...
        add(Instr(Form.STRK, BasicStroke(2f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND)))
        add(Instr(Form.ELPS, Ellipse2D.Double(6.5, -49.5, 12.0, 12.0)))
        add(Instr(Form.FILL, Color.white))
        p = Path2D.Double()
        p.moveTo(8.3, -32.8)
        p.lineTo(12.5, -32.8)
