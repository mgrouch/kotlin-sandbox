...
object Landmarks {
    ...
    private val Base = Symbol().apply {
        ...
        add(Instr(ELPS, Ellipse2D.Double(-10.0, -10.0, 20.0, 20.0)))
        add(Instr(LINE, Line2D.Double(-35.0, 0.0, -10.0, 0.0)))
        add(Instr(LINE, Line2D.Double(10.0, 0.0, 35.0, 0.0)))
    }

    val Chimney = Symbol().apply {
        add(Instr(SYMB, SubSymbol(Base, 1.0, 0.0, 0.0, null, null)))
        add(Instr(STRK, BasicStroke(4f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_MITER)))
        val p = Path2D.Double()
        p.moveTo(-25.0, 0.0)
        p.lineTo(-10.0, -120.0)
    ...
    val ChurchTower = Symbol().apply {
        add(Instr(STRK, BasicStroke(4f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_MITER)))
        add(Instr(RECT, Rectangle2D.Double(-36.0, -36.0, 72.0, 72.0)))
        add(Instr(ELPS, Ellipse2D.Double(-2.0, -2.0, 4.0, 4.0)))
    }

    val Cross = Symbol().apply {
        add(Instr(SYMB, SubSymbol(Base, 1.0, 0.0, 0.0, null, null)))
        add(Instr(STRK, BasicStroke(6f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_MITER)))
        add(Instr(LINE, Line2D.Double(0.0, -10.0, 0.0, -150.0)))
        add(Instr(LINE, Line2D.Double(-30.0, -115.0, 30.0, -115.0)))
    }

    val DishAerial = Symbol().apply {
        add(Instr(SYMB, SubSymbol(Base, 1.0, 0.0, 0.0, null, null)))
        add(Instr(STRK, BasicStroke(4f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_BEVEL)))
        val p = Path2D.Double()
        p.moveTo(-7.8, -6.0)
        p.lineTo(0.0, -62.0)
        p.lineTo(7.8, -6.0)
    ...
    val Dome = Symbol().apply {
        add(Instr(STRK, BasicStroke(4f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_MITER)))
        add(Instr(ELPS, Ellipse2D.Double(-36.0, -36.0, 72.0, 72.0)))
        add(Instr(RSHP, Ellipse2D.Double(-4.0, -4.0, 8.0, 8.0)))
    }
    ...
    val FlareStack = Symbol().apply {
        ...
        p.lineTo(7.8, -6.0)
        add(Instr(PLIN, p))
        add(Instr(STRK, BasicStroke(2f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND)))
        p = Path2D.Double()
        p.moveTo(21.6, -169.6)
    ...
    val LandTower = Symbol().apply {
        add(Instr(SYMB, SubSymbol(Base, 1.0, 0.0, 0.0, null, null)))
        add(Instr(STRK, BasicStroke(4f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_MITER)))
        add(Instr(LINE, Line2D.Double(-25.0, 0.0, -15.0, -120.0)))
        add(Instr(LINE, Line2D.Double(25.0, 0.0, 15.0, -120.0)))
        add(Instr(RECT, Rectangle2D.Double(-15.0, -150.0, 30.0, 30.0)))
    }
    ...
    val Monument = Symbol().apply {
        ...
        add(Instr(LINE, Line2D.Double(-25.0, 0.0, -15.0, -105.0)))
        add(Instr(LINE, Line2D.Double(25.0, 0.0, 15.0, -105.0)))
        add(Instr(EARC, Arc2D.Double(-25.0, -150.0, 50.0, 50.0, 233.0, -285.0, Arc2D.OPEN)))
    }

    val Platform = Symbol().apply {
        add(Instr(STRK, BasicStroke(4f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_MITER)))
        add(Instr(RECT, Rectangle2D.Double(-48.0, -48.0, 96.0, 96.0)))
        add(Instr(RSHP, Ellipse2D.Double(-4.0, -4.0, 8.0, 8.0)))
    }

    val RadioTV = Symbol().apply {
        add(Instr(STRK, BasicStroke(4f, BasicStroke.CAP_ROUND, BasicStroke.JOIN_BEVEL)))
        add(Instr(EARC, Arc2D.Double(-30.0, -180.0, 60.0, 60.0, 45.0, -90.0, Arc2D.OPEN)))
        add(Instr(EARC, Arc2D.Double(-45.0, -195.0, 90.0, 90.0, 45.0, -90.0, Arc2D.OPEN)))
        add(Instr(EARC, Arc2D.Double(-30.0, -180.0, 60.0, 60.0, 225.0, -90.0, Arc2D.OPEN)))
        add(Instr(EARC, Arc2D.Double(-45.0, -195.0, 90.0, 90.0, 225.0, -90.0, Arc2D.OPEN)))
    }

    val Spire = Symbol().apply {
        add(Instr(STRK, BasicStroke(4f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_MITER)))
        add(Instr(ELPS, Ellipse2D.Double(-25.0, -25.0, 50.0, 50.0)))
        add(Instr(RSHP, Ellipse2D.Double(-4.0, -4.0, 8.0, 8.0)))
    }

    val Minaret = Symbol().apply {
        add(Instr(SYMB, SubSymbol(Spire, 1.0, 0.0, 0.0, null, null)))
        add(Instr(STRK, BasicStroke(6f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_MITER)))
        add(Instr(LINE, Line2D.Double(0.0, -25.0, 0.0, -50.0)))
        add(Instr(STRK, BasicStroke(6f, BasicStroke.CAP_ROUND, BasicStroke.JOIN_MITER)))
        add(Instr(EARC, Arc2D.Double(-40.0, -110.0, 80.0, 60.0, 180.0, 180.0, Arc2D.OPEN)))
    }

    val Temple = Symbol().apply {
        add(Instr(STRK, BasicStroke(4f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_MITER)))
        add(Instr(RECT, Rectangle2D.Double(-25.0, -15.0, 50.0, 30.0)))
        add(Instr(STRK, BasicStroke(2f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_MITER)))
        add(Instr(LINE, Line2D.Double(-35.0, -21.0, 35.0, 21.0)))
        add(Instr(LINE, Line2D.Double(-35.0, 21.0, 35.0, -21.0)))
    }
    ...
    val WaterTower = Symbol().apply {
        ...
        add(Instr(LINE, Line2D.Double(-25.0, 0.0, -15.0, -120.0)))
        add(Instr(LINE, Line2D.Double(25.0, 0.0, 15.0, -120.0)))
        add(Instr(RECT, Rectangle2D.Double(-25.0, -150.0, 50.0, 30.0)))
    }

    val WindMotor = Symbol().apply {
        add(Instr(SYMB, SubSymbol(Base, 1.0, 0.0, 0.0, null, null)))
        add(Instr(STRK, BasicStroke(4f, BasicStroke.CAP_ROUND, BasicStroke.JOIN_MITER)))
        add(Instr(LINE, Line2D.Double(0.0, -10.0, 0.0, -90.0)))
        add(Instr(LINE, Line2D.Double(0.0, -90.0, 30.0, -90.0)))
        add(Instr(LINE, Line2D.Double(0.0, -90.0, -14.0, -116.6)))
        add(Instr(LINE, Line2D.Double(0.0, -90.0, -14.3, -66.7)))
    }

    val Windmill = Symbol().apply {
        add(Instr(STRK, BasicStroke(4f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_MITER)))
        add(Instr(ELPS, Ellipse2D.Double(-12.0, -12.0, 24.0, 24.0)))
        add(Instr(LINE, Line2D.Double(-30.0, -42.0, 30.0, 10.0)))
        add(Instr(LINE, Line2D.Double(-30.0, 10.0, 30.0, -42.0)))
    }

    val Windsock = Symbol().apply {
        add(Instr(SYMB, SubSymbol(Base, 1.0, 0.0, 0.0, null, null)))
        add(Instr(STRK, BasicStroke(4f, BasicStroke.CAP_ROUND, BasicStroke.JOIN_MITER)))
        add(Instr(LINE, Line2D.Double(0.0, -10.0, 0.0, -100.0)))
        add(Instr(STRK, BasicStroke(8f, BasicStroke.CAP_ROUND, BasicStroke.JOIN_MITER)))
        add(Instr(LINE, Line2D.Double(0.0, -100.0, 0.0, -150.0)))
