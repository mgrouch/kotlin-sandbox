...
object Buoys {
    ...
    val Barrel = Symbol().apply {
        ...
        addInstr(LINE, Line2D.Double(-57.0, 0.0, -10.0, 0.0))
        addInstr(LINE, Line2D.Double(10.0, 0.0, 50.0, 0.0))
        p = Path2D.Double()
        p.moveTo(-50.0, 0.0)
        p.curveTo(-50.0, -11.0, -45.0, -32.0, -32.0, -36.0)
        p.curveTo(-18.0, -40.0, 12.0, -40.0, 25.0, -36.0)
    ...
    val Float = Symbol().apply {
        ...
        addInstr(FILL, black)
        addInstr(ELPS, Ellipse2D.Double(-10.0, -10.0, 20.0, 20.0))
        addInstr(LINE, Line2D.Double(-54.0, 0.0, -10.0, 0.0))
        addInstr(LINE, Line2D.Double(10.0, 0.0, 54.0, 0.0))
        p = Path2D.Double()
        p.moveTo(-36.0, 0.0)
        p.lineTo(-47.0, -33.0)
    ...
    val Pillar = Symbol().apply {
        ...
        addInstr(FILL, black)
        addInstr(ELPS, Ellipse2D.Double(-10.0, -10.0, 20.0, 20.0))
        addInstr(LINE, Line2D.Double(-42.0, 0.0, -10.0, 0.0))
        addInstr(LINE, Line2D.Double(10.0, 0.0, 36.0, 0.0))
        p = Path2D.Double()
        p.moveTo(-32.0, 0.0)
        p.lineTo(-2.8, -32.5)
        p.lineTo(25.6, -96.7)
    ...
    val Sphere = Symbol().apply {
        ...
        addInstr(LINE, Line2D.Double(10.0, 0.0, 40.0, 0.0))
        addInstr(EARC, Arc2D.Double(-26.5, -39.4, 60.0, 60.0, -18.0, 216.0, Arc2D.OPEN))
    }
