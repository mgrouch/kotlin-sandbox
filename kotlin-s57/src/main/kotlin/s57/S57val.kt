...
object S57val {
    ...
    private val keys = mapOf(
        Att.UNKATT to S57key(Conv.A, null),
        Att.AGENCY to S57key(Conv.A, null),
        Att.BCNSHP to S57key(Conv.E, Bcnshp),
        Att.BUISHP to S57key(Conv.E, Buishp),
        Att.BOYSHP to S57key(Conv.E, Boyshp),
        Att.BURDEP to S57key(Conv.F, null),
        Att.CALSGN to S57key(Conv.S, null),
        Att.CATAIR to S57key(Conv.L, Catair),
        Att.CATACH to S57key(Conv.L, Catach),
        Att.CATBRG to S57key(Conv.L, Catbrg),
        Att.CATBUA to S57key(Conv.E, Catbua),
        Att.CATCBL to S57key(Conv.E, Catcbl),
        Att.CATCAN to S57key(Conv.E, Catcan),
        Att.CATCAM to S57key(Conv.E, Catcam),
        Att.CATCHP to S57key(Conv.E, Catchp),
        Att.CATCOA to S57key(Conv.E, Catcoa),
        Att.CATCTR to S57key(Conv.E, Catctr),
        Att.CATCON to S57key(Conv.E, Catcon),
        Att.CATCRN to S57key(Conv.E, Catcrn),
        Att.CATDAM to S57key(Conv.E, Catdam),
        Att.CATDIS to S57key(Conv.E, Catdis),
        Att.CATDOC to S57key(Conv.E, Catdoc),
        Att.CATDPG to S57key(Conv.L, Catdpg),
        Att.CATFNC to S57key(Conv.E, Catfnc),
        Att.CATFRY to S57key(Conv.E, Catfry),
        Att.CATFIF to S57key(Conv.E, Catfif),
        Att.CATFOG to S57key(Conv.E, Catfog),
        Att.CATFOR to S57key(Conv.E, Catfor),
        Att.CATGAT to S57key(Conv.E, Catgat),
        Att.CATHAF to S57key(Conv.L, Cathaf),
        Att.CATHLK to S57key(Conv.L, Cathlk),
        Att.CATICE to S57key(Conv.E, Catice),
        Att.CATINB to S57key(Conv.E, Catinb),
        Att.CATLND to S57key(Conv.L, Catlnd),
        Att.CATLMK to S57key(Conv.L, Catlmk),
        Att.CATLAM to S57key(Conv.E, Catlam),
        Att.CATLIT to S57key(Conv.L, Catlit),
        Att.CATMFA to S57key(Conv.E, Catmfa),
        Att.CATMPA to S57key(Conv.L, Catmpa),
        Att.CATMOR to S57key(Conv.E, Catmor),
        Att.CATNAV to S57key(Conv.E, Catnav),
        Att.CATOBS to S57key(Conv.E, Catobs),
        Att.CATOFP to S57key(Conv.L, Catofp),
        Att.CATOLB to S57key(Conv.E, Catolb),
        Att.CATPLE to S57key(Conv.E, Catple),
        Att.CATPIL to S57key(Conv.E, Catpil),
        Att.CATPIP to S57key(Conv.L, Catpip),
        Att.CATPRA to S57key(Conv.E, Catpra),
        Att.CATPYL to S57key(Conv.E, Catpyl),
        Att.CATRAS to S57key(Conv.E, Catras),
        Att.CATRTB to S57key(Conv.E, Catrtb),
        Att.CATROS to S57key(Conv.L, Catros),
        Att.CATTRK to S57key(Conv.E, Cattrk),
        Att.CATRSC to S57key(Conv.L, Catrsc),
        Att.CATREA to S57key(Conv.L, Catrea),
        Att.CATROD to S57key(Conv.E, Catrod),
        Att.CATRUN to S57key(Conv.E, Catrun),
        Att.CATSEA to S57key(Conv.E, Catsea),
        Att.CATSIL to S57key(Conv.E, Catsil),
        Att.CATSLO to S57key(Conv.E, Catslo),
        Att.CATSCF to S57key(Conv.L, Catscf),
        Att.CATSLC to S57key(Conv.E, Catslc),
        Att.CATSIT to S57key(Conv.L, Catsit),
        Att.CATSIW to S57key(Conv.L, Catsiw),
        Att.CATSPM to S57key(Conv.L, Catspm),
        Att.CATTSS to S57key(Conv.E, Cattss),
        Att.CATVEG to S57key(Conv.L, Catveg),
        Att.CATWAT to S57key(Conv.E, Catwat),
        Att.CATWED to S57key(Conv.E, Catwed),
        Att.CATWRK to S57key(Conv.E, Catwrk),
        Att.COLOUR to S57key(Conv.L, Colour),
        Att.COLPAT to S57key(Conv.L, Colpat),
        Att.COMCHA to S57key(Conv.A, null),
        Att.CPDATE to S57key(Conv.A, null),
        Att.CSCALE to S57key(Conv.I, null),
        Att.CONDTN to S57key(Conv.E, Condtn),
        Att.CONRAD to S57key(Conv.E, Conrad),
        Att.CONVIS to S57key(Conv.E, Convis),
        Att.CURVEL to S57key(Conv.F, null),
        Att.DATEND to S57key(Conv.A, null),
        Att.DATSTA to S57key(Conv.A, null),
        Att.DRVAL1 to S57key(Conv.F, null),
        Att.DRVAL2 to S57key(Conv.F, null),
        Att.ELEVAT to S57key(Conv.F, null),
        Att.ESTRNG to S57key(Conv.F, null),
        Att.EXCLIT to S57key(Conv.E, Exclit),
        Att.EXPSOU to S57key(Conv.E, Expsou),
        Att.FUNCTN to S57key(Conv.L, Functn),
        Att.HEIGHT to S57key(Conv.F, null),
        Att.HUNITS to S57key(Conv.E, Hunits),
        Att.HORACC to S57key(Conv.F, null),
        Att.HORCLR to S57key(Conv.F, null),
        Att.HORLEN to S57key(Conv.F, null),
        Att.HORWID to S57key(Conv.F, null),
        Att.ICEFAC to S57key(Conv.F, null),
        Att.INFORM to S57key(Conv.S, null),
        Att.JRSDTN to S57key(Conv.E, Jrsdtn),
        Att.LIFCAP to S57key(Conv.F, null),
        Att.LITCHR to S57key(Conv.E, Litchr),
        Att.LITVIS to S57key(Conv.L, Litvis),
        Att.MARSYS to S57key(Conv.E, Marsys),
        Att.MLTYLT to S57key(Conv.I, null),
        Att.NATION to S57key(Conv.A, null),
        Att.NATCON to S57key(Conv.L, Natcon),
        Att.NATSUR to S57key(Conv.L, Natsur),
        Att.NATQUA to S57key(Conv.L, Natqua),
        Att.NMDATE to S57key(Conv.A, null),
        Att.OBJNAM to S57key(Conv.S, null),
        Att.ORIENT to S57key(Conv.F, null),
        Att.PEREND to S57key(Conv.A, null),
        Att.PERSTA to S57key(Conv.A, null),
        Att.PICREP to S57key(Conv.S, null),
        Att.PILDST to S57key(Conv.S, null),
        Att.PRCTRY to S57key(Conv.A, null),
        Att.PRODCT to S57key(Conv.L, Prodct),
        Att.PUBREF to S57key(Conv.S, null),
        Att.QUASOU to S57key(Conv.L, Quasou),
        Att.RADWAL to S57key(Conv.A, null),
        Att.RADIUS to S57key(Conv.F, null),
        Att.RYRMGV to S57key(Conv.A, null),
        Att.RESTRN to S57key(Conv.L, Restrn),
        Att.SCAMIN to S57key(Conv.I, null),
        Att.SCVAL1 to S57key(Conv.I, null),
        Att.SCVAL2 to S57key(Conv.I, null),
        Att.SECTR1 to S57key(Conv.F, null),
        Att.SECTR2 to S57key(Conv.F, null),
        Att.SHIPAM to S57key(Conv.A, null),
        Att.SIGFRQ to S57key(Conv.I, null),
        Att.SIGGEN to S57key(Conv.E, Siggen),
        Att.SIGGRP to S57key(Conv.A, null),
        Att.SIGPER to S57key(Conv.F, null),
        Att.SIGSEQ to S57key(Conv.A, null),
        Att.SOUACC to S57key(Conv.F, null),
        Att.SDISMX to S57key(Conv.I, null),
        Att.SDISMN to S57key(Conv.I, null),
        Att.SORDAT to S57key(Conv.A, null),
        Att.SORIND to S57key(Conv.A, null),
        Att.STATUS to S57key(Conv.L, Status),
        Att.SURATH to S57key(Conv.S, null),
        Att.SUREND to S57key(Conv.A, null),
        Att.SURSTA to S57key(Conv.A, null),
        Att.SURTYP to S57key(Conv.L, Surtyp),
        Att.TECSOU to S57key(Conv.L, Tecsou),
        Att.TXTDSC to S57key(Conv.S, null),
        Att.TS_TSP to S57key(Conv.A, null),
        Att.TS_TSV to S57key(Conv.A, null),
        Att.T_ACWL to S57key(Conv.E, null),
        Att.T_HWLW to S57key(Conv.A, null),
        Att.T_MTOD to S57key(Conv.E, null),
        Att.T_THDF to S57key(Conv.A, null),
        Att.T_TINT to S57key(Conv.I, null),
        Att.T_TSVL to S57key(Conv.A, null),
        Att.T_VAHC to S57key(Conv.A, null),
        Att.TIMEND to S57key(Conv.A, null),
        Att.TIMSTA to S57key(Conv.A, null),
        Att.TOPSHP to S57key(Conv.E, Topshp),
        Att.TRAFIC to S57key(Conv.E, Trafic),
        Att.VALACM to S57key(Conv.F, null),
        Att.VALDCO to S57key(Conv.F, null),
        Att.VALLMA to S57key(Conv.F, null),
        Att.VALMAG to S57key(Conv.F, null),
        Att.VALMXR to S57key(Conv.F, null),
        Att.VALNMR to S57key(Conv.F, null),
        Att.VALSOU to S57key(Conv.F, null),
        Att.VERACC to S57key(Conv.F, null),
        Att.VERCLR to S57key(Conv.F, null),
        Att.VERCCL to S57key(Conv.F, null),
        Att.VERCOP to S57key(Conv.F, null),
        Att.VERCSA to S57key(Conv.F, null),
        Att.VERDAT to S57key(Conv.E, Verdat),
        Att.VERLEN to S57key(Conv.F, null),
        Att.WATLEV to S57key(Conv.E, Watlev),
        Att.CAT_TS to S57key(Conv.E, Cat_ts),
        Att.NINFOM to S57key(Conv.S, null),
        Att.NOBJNM to S57key(Conv.S, null),
        Att.NPLDST to S57key(Conv.S, null),
        Att.NTXTDS to S57key(Conv.S, null),
        Att.HORDAT to S57key(Conv.E, null),
        Att.POSACC to S57key(Conv.F, null),
        Att.QUAPOS to S57key(Conv.E, Quapos),
        Att.CLSDNG to S57key(Conv.E, Clsdng),
        Att.DIRIMP to S57key(Conv.L, Dirimp),
        Att.DISBK1 to S57key(Conv.F, null),
        Att.DISBK2 to S57key(Conv.F, null),
        Att.DISIPU to S57key(Conv.F, null),
        Att.DISIPD to S57key(Conv.F, null),
        Att.ELEVA1 to S57key(Conv.F, null),
        Att.ELEVA2 to S57key(Conv.F, null),
        Att.FNCTNM to S57key(Conv.E, Fnctnm),
        Att.WTWDIS to S57key(Conv.F, null),
        Att.BUNVES to S57key(Conv.E, Bunves),
        Att.COMCTN to S57key(Conv.S, null),
        Att.HORCLL to S57key(Conv.F, null),
        Att.HORCLW to S57key(Conv.F, null),
        Att.TRSHGD to S57key(Conv.L, Trshgd),
        Att.UNLOCD to S57key(Conv.S, null),
        Att.HIGWAT to S57key(Conv.F, null),
        Att.HIGNAM to S57key(Conv.S, null),
        Att.LOWWAT to S57key(Conv.F, null),
        Att.LOWNAM to S57key(Conv.S, null),
        Att.MEAWAT to S57key(Conv.F, null),
        Att.MEANAM to S57key(Conv.S, null),
        Att.OTHWAT to S57key(Conv.F, null),
        Att.OTHNAM to S57key(Conv.S, null),
        Att.REFLEV to S57key(Conv.E, Reflev),
        Att.SDRLEV to S57key(Conv.S, null),
        Att.VCRLEV to S57key(Conv.S, null),
        Att.SCHREF to S57key(Conv.S, null),
        Att.USESHP to S57key(Conv.E, Useshp),
        Att.CURVHW to S57key(Conv.F, null),
        Att.CURVLW to S57key(Conv.F, null),
        Att.CURVMW to S57key(Conv.F, null),
        Att.CURVOW to S57key(Conv.F, null),
        Att.APTREF to S57key(Conv.S, null),
        Att.SHPTYP to S57key(Conv.E, Shptyp),
        Att.UPDMSG to S57key(Conv.S, null),
        Att.ADDMRK to S57key(Conv.L, Addmrk),
        Att.BNKWTW to S57key(Conv.E, Bnkwtw),
        Att.CATNMK to S57key(Conv.E, Catnmk),
        Att.CATBRT to S57key(Conv.L, Catbrt),
        Att.CATBUN to S57key(Conv.L, Catbun),
        Att.CATCCL to S57key(Conv.L, Catccl),
        Att.CATCOM to S57key(Conv.L, Catcom),
        Att.CATHBR to S57key(Conv.L, Cathbr),
        Att.CATRFD to S57key(Conv.L, Catrfd),
        Att.CATTML to S57key(Conv.L, Cattml),
        Att.CATGAG to S57key(Conv.L, Catgag),
        Att.CATVTR to S57key(Conv.L, Catvtr),
        Att.CATTAB to S57key(Conv.E, Cattab),
        Att.CATEXS to S57key(Conv.E, Catexs),
        Att.LG_SPD to S57key(Conv.F, null),
        Att.LG_SPR to S57key(Conv.L, Lg_spr),
        Att.LG_BME to S57key(Conv.F, null),
        Att.LG_LGS to S57key(Conv.F, null),
        Att.LG_DRT to S57key(Conv.F, null),
        Att.LG_WDP to S57key(Conv.F, null),
        Att.LG_WDU to S57key(Conv.E, Lg_wdu),
        Att.LG_REL to S57key(Conv.L, Lg_rel),
        Att.LG_FNC to S57key(Conv.L, Lg_fnc),
        Att.LG_DES to S57key(Conv.S, null),
        Att.LG_PBR to S57key(Conv.S, null),
        Att.LC_CSI to S57key(Conv.L, Lc_csi),
        Att.LC_CSE to S57key(Conv.L, Lc_cse),
        Att.LC_ASI to S57key(Conv.L, Lc_asi),
        Att.LC_ASE to S57key(Conv.L, Lc_ase),
        Att.LC_CCI to S57key(Conv.L, Lc_cci),
        Att.LC_CCE to S57key(Conv.L, Lc_cce),
        Att.LC_BM1 to S57key(Conv.F, null),
        Att.LC_BM2 to S57key(Conv.F, null),
        Att.LC_LG1 to S57key(Conv.F, null),
        Att.LC_LG2 to S57key(Conv.F, null),
        Att.LC_DR1 to S57key(Conv.F, null),
        Att.LC_DR2 to S57key(Conv.F, null),
        Att.LC_SP1 to S57key(Conv.F, null),
        Att.LC_SP2 to S57key(Conv.F, null),
        Att.LC_WD1 to S57key(Conv.F, null),
        Att.LC_WD2 to S57key(Conv.F, null),
